...
model = tf.saved_model.load('D:\scanx\ScanX\model_text\my_model')
...
def predict_text(text):
    ...
    # Assuming the model returns logits, apply softmax to get probabilities
    logits = predictions['logits']  # Change 'output' to the actual output tensor name
