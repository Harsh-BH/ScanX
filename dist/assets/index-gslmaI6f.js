import{b6 as _,b9 as x,b7 as v,ba as I,aC as c,aD as C,az as E,d as m,aA as b,aF as u,aH as y,aM as A,aG as d,bb as p,aJ as h,bc as T,aB as N,aI as O}from"./index-CO98qFAu.js";import{bd as P,bf as z,be as D}from"./index-CO98qFAu.js";const i=_({status:"uninitialized"}),g={state:i,subscribeKey(t,e){return x(i,t,e)},subscribe(t){return v(i,()=>t(i))},_getClient(){if(!i._client)throw new Error("SIWEController client not set");return i._client},async getNonce(t){const n=await this._getClient().getNonce(t);return this.setNonce(n),n},async getSession(){try{const e=await this._getClient().getSession();return e&&(this.setSession(e),this.setStatus("success")),e||void 0}catch{return}},createMessage(t){const n=this._getClient().createMessage(t);return this.setMessage(n),n},async verifyMessage(t){return await this._getClient().verifyMessage(t)},async signIn(){return await this._getClient().signIn()},async signOut(){var e;const t=this._getClient();await t.signOut(),this.setStatus("ready"),this.setSession(void 0),(e=t.onSignOut)==null||e.call(t)},onSignIn(t){var n;const e=this._getClient();(n=e.onSignIn)==null||n.call(e,t)},onSignOut(){var e;const t=this._getClient();(e=t.onSignOut)==null||e.call(t)},async setSIWEClient(t){i._client=I(t),i.session=await this.getSession(),i.status=i.session?"success":"ready",c.setAccountProp("siweStatus",i.status,"eip155"),C.setIsSiweEnabled(t.options.enabled)},setNonce(t){i.nonce=t},setStatus(t){i.status=t,c.setAccountProp("siweStatus",i.status,"eip155")},setMessage(t){i.message=t},setSession(t){i.session=t,i.status=t?"success":"ready",c.setAccountProp("siweStatus",i.status,"eip155")}},R=E`
  :host {
    display: flex;
